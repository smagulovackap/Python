...
# text = input()
# a, b = text.find('h'), text.rfind('h')
# print(text[1:a] + text[b+1:])

# text = input()
# a, b = text.find('h'), text.rfind('h')
# print(text.replace(text[a:b+1], ""))


# year = 2010
# k = '10k'
# what = 'Bitcoin'
# print(f'In {year}, someone paid {k} {what} for two pizzas.')
...
Это их и подвело, ведь данный шифр очень простой. Однако в постапокалипсисе люди
плохо знают все тонкости довоенного мира, поэтому ученые из НКР не могут понять как именно нужно декодировать данные сообщения. 
...
"""На вход программе подается одно число n. Напишите программу, которая выводит список 1, 2, 3, 4 ... n"""
# n = int(input())
...
# min_and_max = [max(numbers), min(numbers)]
# print(sum(min_and_max))
...
"""На вход программе подается натуральное число n, а затем 
n целых чисел. Напишите программу, которая создает из указанных чисел список, затем удаляет все 
...
3. а теперь уже вводим число k через инт
4. цикл for i in range(n)
